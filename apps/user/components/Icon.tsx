...
function CbrainAuthorIcon({ size = 20, ...props }: Omit<IconProps, "name">) {
  return (
    <svg
      aria-hidden="true"
      fill="none"
      ...
      {...props}
    >
      <rect fill="#30BAC3" height="20" rx="10" width="20" />
      <path
        d="M11.875 15.759C11.875 16.3276 11.7195 16.7653 11.4085 17.0572C11.0976 17.3541 10.6311 17.5 10.0046 17.5C8.75152 17.5 8.125 16.9264 8.125 15.7741V4.2209C8.125 3.07363 8.75152 2.5 10.0046 2.5C10.6174 2.5 11.0838 2.64089 11.3994 2.92771C11.7149 3.20949 11.875 3.64223 11.875 4.21084V8.4678H10.4116V4.10013C10.4116 3.91395 10.3796 3.77809 10.3201 3.69255C10.2607 3.60701 10.1555 3.56676 10.0046 3.56676C9.86738 3.56676 9.7622 3.60198 9.6936 3.67746C9.625 3.75294 9.58841 3.89383 9.58841 4.10013V15.8093C9.58841 16.0055 9.62043 16.1414 9.68445 16.232C9.74848 16.3175 9.85366 16.3578 10.0046 16.3578C10.1555 16.3578 10.2607 16.3175 10.3201 16.237C10.3796 16.1565 10.4116 16.0156 10.4116 15.8093V10.6365H11.875V15.764V15.759Z"
        fill="#ffffff"
      />
    </svg>
  );
...
const icons = {
  ...
  camera: CameraIcon,
  "cbrain-author": CbrainAuthorIcon,
