...
export function AboutSection() {
  return (
    <SectionLayout
      badge="씨브레인(C-Brain) 소개"
      badgeClassName={styles.aboutKicker}
      className={styles.aboutSection}
      description={
        <>
          씨브레인은 2000년 설립 이후 26년간 전국 1,200여 곳과의 파트너십과
          4,000건 이상의 제작 실적을 보유한
          <br className={styles.aboutDesktopBreak} /> 브로슈어 · 카탈로그 및
          각종 홍보물 기획 · 디자인 · 인쇄 원스톱 제작 전문 기업입니다.
        </>
      }
      descriptionClassName={styles.aboutDescription}
      id="about"
      innerClassName={styles.aboutInner}
      title={
        <>
      ...
      titleClassName={styles.aboutTitle}
    >
